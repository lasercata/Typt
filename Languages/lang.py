...
def translate(text_en, lang=lang):
    ...
    try:
        ...
        if lang == 'fr':
            print("Typt: lang.py: Impossible de traduire '{}' : non trouvé.".format(text_en))

        else:
            print("Typt: lang.py: Can't translate '{}' : not found.".format(text_en))
