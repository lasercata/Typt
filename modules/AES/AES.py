...
try:
    lib_AES = ctypes.cdll.LoadLibrary('{}/modules/AES/AES_library/{}'.format(os.getcwd(), dll_fn))

except OSError as err:
    if platform.system() == 'Windows':
        lib_AES = ctypes.cdll.LoadLibrary('{}/modules/AES/AES_library/{}'.format(os.getcwd(), 'AES_win_2.dll'))
